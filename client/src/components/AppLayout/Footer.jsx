          ...
          <div className="lg:w-1/3 md:w-1/3 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                ...
                <a className="text-gray-100 hover:text-gray-300" href="https://www.facebook.com/profile.php?id=100090370347556&mibextid=LQQJ4d">  Excellence-Informatique-Bureautique </a>
              </li>

              <li>
                <a className="text-gray-500" href="https://api.whatsapp.com/send?phone=22237373817">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="15px" viewBox="0 0 20 20" version="1.1">
                ...
                <a className="text-gray-100 hover:text-gray-300" href="https://api.whatsapp.com/send?phone=22237373817">  (+222) 37-37-38-17</a>
              </li>

              <li>
                <a className="text-gray-500" href="https://mail.google.com/mail/u/1/?fs=1&to=Achat@Excellence-Informatique.com&tf=cm">
                ...
                <a className="text-gray-100 hover:text-gray-300" href="https://mail.google.com/mail/u/1/?fs=1&to=Achat@Excellence-Informatique.com&tf=cm">  Achat@Excellence-Informatique.com</a></li>
            </nav>
          </div>
          <div className="lg:w-1/3 md:w-1/3 w-full px-4">
      ...
      <div className="bg-gray-200">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">
            <a href="https://mail.google.com/mail/u/1/?fs=1&to=talebbahan@gmail.com&tf=cm" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">© 2023 Taleb Bahan — @talebbahan@gmail.com</a>
          </p>
          <span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm"><a className="text-gray-600 ml-1" href="https://api.whatsapp.com/send?phone=22222055855">FullStack Developper 22-05-58-55</a></span>
        </div>
      </div>
    </footer>
  );
